...
CRITICAL RULE: If the query asks "Which subsystem", "Find subsystems", "Find severe overruns", or asks an aggregate question about ALL subsystems, you MUST use "system_analytics", even if it contains words like 'equipment' or 'risk'.
...
Use subsystem_cost for cost, planned cost, actual cost, or remaining budget of a SPECIFIC subsystem.
Use cost_breakdown for labor, material, equipment of a SPECIFIC subsystem.
